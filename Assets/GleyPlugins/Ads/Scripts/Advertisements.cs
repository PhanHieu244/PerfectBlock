...
public class Advertisements : MonoBehaviour
{
    ...
    public void Initialize()
    {
        if (initialized == false)
        {
            ...
            if (adSettings.advertiserSettings.First(cond => cond.advertiser == SupportedAdvertisers.MoPub).useSDK)
            {
            ...
            if (adSettings.advertiserSettings.First(cond => cond.advertiser == SupportedAdvertisers.IronSource).useSDK)
            {
